...
import CustomHeaderButton from "../components/CustomHeaderButtion";
  ...
  return (
    <MealsNavigator.Navigator initialRouteName="Categories" screenOptions={{ headerStyle: { backgroundColor: "#4a148c", },headerTintColor:"white", }}>
      ...
      options={{headerRight: () => (
        ...
        <Item title="" iconName="ios-star" onPress={() => {toggleFavoriteHandler()}} />
        </HeaderButtons> ),}}/>
...
function FavNavigator(){
  return(
    <FavsNavigator.Navigator screenOptions={{ headerStyle: { backgroundColor: "#4a148c", },headerTintColor:"white", }}>
      <FavsNavigator.Screen name="Your Favorites" component={FavoriteScreen}/>
      <FavsNavigator.Screen name="MealDetail" component={MealDetailScreen}/>
